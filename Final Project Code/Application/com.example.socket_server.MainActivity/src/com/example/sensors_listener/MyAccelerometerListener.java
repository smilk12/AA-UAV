...
/**
 * MyAccelerometerListener is a class that implements SensorEventListener
 * and gives us access to the phone Accelerometer sensor values.
 * 
 * 
...
public class MyAccelerometerListener implements SensorEventListener{
	...
	/** 
	 * MyAccelerometerListener constructor initialize class variables.
	 *
	 * @param sensor the sensor service.    
	 * @see             SensorManager.
	 * @since           1.0
	 */	
	public MyAccelerometerListener(SensorManager sensor){
	...
	//********************* ..:: getAccelerometer ::.. ***********************//
	/** 
	 * getAccelerometer method returns the sensor values.
	 *
